    ...
    try {
      ...
      const items = collections.map(collection => {
        ...
        return {
          ...
          rules_canon: collection.rules_canon,
          source: collection.source,
          content_version: collection.content_version,
          temporal_strategy: collection.temporal_strategy,
          active_period: collection.active_period,
          status: collection.status,
          published_at: collection.published_at,
          last_refresh_at: collection.last_refresh_at,
          auto_refresh_enabled: collection.auto_refresh_enabled,
          refresh_cadence_days: collection.refresh_cadence_days,
  ...
  fastify.get('/collections/:slug', async (request, reply) => {
    try {
      ...
      const collection = {
        ...
        rules_canon: firstRow.collection_rules_canon,
        source: firstRow.collection_source,
        content_version: firstRow.collection_content_version,
        temporal_strategy: firstRow.collection_temporal_strategy,
        active_period: firstRow.collection_active_period,
        status: firstRow.collection_status,
        published_at: firstRow.collection_published_at,
        last_refresh_at: firstRow.collection_last_refresh_at,
        auto_refresh_enabled: firstRow.collection_auto_refresh_enabled,
        refresh_cadence_days: firstRow.collection_refresh_cadence_days,
        metadata: firstRow.collection_metadata,
